...
public class DataContext {
    ...
    public static boolean addTeacher(Teacher teacher){
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("src/sge/data/teacher.data", true))) {
    ...
    public static boolean removeTeacher(Teacher teacher){
        ...
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/sge/data/teacher.data", false))){
            DataContext.TEACHERS.remove(teacher);
    ...
    public static boolean addDepartment(Department department){
        ...
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/sge/data/department.data", true))){
    ...
    public static boolean removeDepartment(Department department){
       ...
       try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/sge/data/department.data", false))){
            DataContext.DEPARTMENTS.remove(department);
            writer.write(fileHeader);
            writer.newLine();
    ...
    public static boolean addMajor(Major major){
        ...
        try(BufferedWriter writer = new BufferedWriter(new FileWriter("src/sge/data/major.data", true))){
