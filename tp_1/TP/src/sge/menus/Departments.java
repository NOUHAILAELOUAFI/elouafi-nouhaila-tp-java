...
import sge.options.department.Create;
import sge.options.department.ListAll;
import sge.options.department.Remove;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

public class Departments implements Menu {
